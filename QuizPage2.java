...
public class QuizPage2 extends JFrame implements ActionListener {
JPanel panel;
...
qus = new JLabel("Association can be : ");
...
op1 = new JButton("One-to-one");
op1.setBounds(100,150,500,50);
op1.addActionListener(this);
panel.add(op1);

op2 = new JButton("One-to-many. ");
op2.setBounds(100,220,500,50); 
op2.addActionListener(this);
panel.add(op2);

op3 = new JButton(" Many-to-one");
op3.setBounds(100,290,500,50);
op3.addActionListener(this);
panel.add(op3);

op4 = new JButton(" All of them.");
...
if (ae.getSource()==op1) {
    ...
    QuizPage3 quizPage3 = new QuizPage3();

    this.setVisible(false);
    quizPage3.setVisible(true);
