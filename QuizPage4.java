...
public class QuizPage4 extends JFrame implements ActionListener {
JPanel panel;
...
qus = new JLabel("Which one is platform independent programming language?!");
...
if (ae.getSource()==op1) {
    ...
    QuizPage5 quizPage5 = new QuizPage5();

    this.setVisible(false);
    quizPage5.setVisible(true);
