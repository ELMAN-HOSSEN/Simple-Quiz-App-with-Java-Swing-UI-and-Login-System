...
public class QuizPage3 extends JFrame implements ActionListener {
JPanel panel;
...
qus = new JLabel("IInterfaces are : ");
...
op1 = new JButton("Public. ");
op1.setBounds(100,150,500,50);
op1.addActionListener(this);
panel.add(op1);

op2 = new JButton("Private");
op2.setBounds(100,220,500,50); 
op2.addActionListener(this);
panel.add(op2);

op3 = new JButton(" By default Public");
op3.setBounds(100,290,500,50);
op3.addActionListener(this);
panel.add(op3);

op4 = new JButton("Protected.");
...
if (ae.getSource()==op1) {
    ...
    QuizPage4 quizPage4 = new QuizPage4();

    this.setVisible(false);
    quizPage4.setVisible(true);
